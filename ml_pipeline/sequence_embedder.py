...
class SequenceEmbedder:
    ...
    def __init__(self, encoder, silence_detector, type_classifier, km, param):
        """
            ...
            if len(batch) == 1000:
                ...
                for i in range(0, len(batch)):
                    if int(round(is_silence[i][0])) == 0:
                        ...
                        start     = batch[i][2]
                        stop      = batch[i][3]
                        print('- Found non silent region {} {}:{} extracting embedding of size {} / {} with [{}, {}]'.format(filename, start / 48000, stop / 48000, embedding[i, :].shape, len(regions), t, c))
