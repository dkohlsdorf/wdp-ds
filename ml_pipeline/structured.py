...
def make_hmm(cluster, assignment, overlapping, min_len = 4, max_train=25):
    """
    Learn a 4 state Hidden Markov Model.
    ...
    if frames > min_len:        
        ...
        l = 0.1
        s = 0.9
        trans_mat = DenseMarkovChain.from_probs([[s,    l, 0.0, 0.0],
                                                 [0.0,  s,   l, 0.0],
                                                 [0.0, 0.0,  s,   l],
                                                 [0.0, 0.0,  0.0, s]])
