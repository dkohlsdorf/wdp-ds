...
class DTWTest(unittest.TestCase):
    ...
    def test_dtw_edge(self):
        distance, path = DTWTest.ALIGN.align(DTWTest.X, DTWTest.Z) 
        self.assertAlmostEqual(distance, 2.0, delta=1e-8)
        self.assertListEqual(list(path), [(1, 1), (2, 1), (3, 1), (4, 1)])